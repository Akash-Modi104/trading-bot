...
ssh $Server "set -e; cd $RemotePath; git fetch origin; git reset --hard origin/main; venv/bin/pip install -r requirements.txt --quiet; echo `"Code updated successfully`""
